...
#include "sim_user_interface_functions.h"
...
tagButton buttons[] = 
{
  ...
  { NULL,            powerbutton, { &rotarydials[7].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ROUNDED_RECT,      60,     610,    80,     35,      2, 0, "POWER",     2, 1, &bluebutton,     SimPanelColor },
  { NULL,           selectbutton, {     &buttons[0].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ROUNDED_RECT,     400,     600,    50,     25,      2, 0, "SEL",       3, 0, &whitebutton,    SimPanelColor },
  { NULL,        selectallbutton, {     &buttons[1].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ROUNDED_RECT,     490,     600,    50,     25,      2, 0, "SEL ALL",   3, 0, &whitebutton,    SimPanelColor },
  { NULL,           deletebutton, {     &buttons[2].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ROUNDED_RECT,     580,     600,    50,     25,      2, 0, "DEL",       3, 0, &whitebutton,    SimPanelColor },
  { NULL,             lastbutton, {     &buttons[3].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ROUNDED_RECT,     670,     600,    50,     25,      2, 0, "LAST",      3, 0, &whitebutton,    SimPanelColor },
  { NULL,             nextbutton, {     &buttons[4].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ROUNDED_RECT,     760,     600,    50,     25,      2, 0, "NEXT",      3, 0, &whitebutton,    SimPanelColor },
  { NULL,               f1button, {     &buttons[5].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ROUNDED_RECT,     904,     105,    50,     25,      2, 0, "F1",        3, 0, &greybutton,     SimPanelColor },
  { NULL,               f2button, {     &buttons[6].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ROUNDED_RECT,     904,     187,    50,     25,      2, 0, "F2",        3, 0, &greybutton,     SimPanelColor },
  { NULL,               f3button, {     &buttons[7].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ROUNDED_RECT,     904,     269,    50,     25,      2, 0, "F3",        3, 0, &greybutton,     SimPanelColor },
  { NULL,               f4button, {     &buttons[8].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ROUNDED_RECT,     904,     351,    50,     25,      2, 0, "F4",        3, 0, &greybutton,     SimPanelColor },
  { NULL,               f5button, {     &buttons[9].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ROUNDED_RECT,     904,     433,    50,     25,      2, 0, "F5",        3, 0, &greybutton,     SimPanelColor },
  { NULL,               f6button, {    &buttons[10].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ROUNDED_RECT,     904,     515,    50,     25,      2, 0, "F6",        3, 0, &greybutton,     SimPanelColor },
  { NULL,        generatorbutton, {    &buttons[11].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_DIAMOND,          904,     600,    50,     25,      2, 0, "GEN",       3, 1, &darkbluebutton, SimPanelColor },
  { NULL,             slowbutton, {    &buttons[12].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ROUNDED_RECT,    1035,     175,    50,     25,      2, 0, "SLOW",      2, 0, &greybutton,     SimPanelColor },

  { NULL,             leftbutton, {    &buttons[13].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ARROW_LEFT,      1100,     120,    25,     35,      2, 0, "",          2, 0, &greybutton,     SimPanelColor },
  { NULL,               upbutton, {    &buttons[14].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ARROW_UP,        1150,      75,    35,     25,      2, 0, "",          2, 0, &greybutton,     SimPanelColor },
  { NULL,               okbutton, {    &buttons[15].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ROUNDED_RECT,    1150,     120,    35,     35,      4, 0, "OK",        2, 0, &greybutton,     SimPanelColor },
  { NULL,             downbutton, {    &buttons[16].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ARROW_DOWN,      1150,     175,    35,     25,      2, 0, "",          2, 0, &greybutton,     SimPanelColor },
  { NULL,            rightbutton, {    &buttons[17].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ARROW_RIGHT,     1210,     120,    25,     35,      2, 0, "",          2, 0, &greybutton,     SimPanelColor },
  
  { NULL, horizontalcursorbutton, {    &buttons[18].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ROUNDED_RECT,    1260,      75,    50,     25,      2, 0, "H CUR",     2, 0, &greybutton,     SimPanelColor },
  { NULL,   verticalcursorbutton, {    &buttons[19].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ROUNDED_RECT,    1260,     175,    50,     25,      2, 0, "V CUR",     2, 0, &greybutton,     SimPanelColor },
  { NULL,             menubutton, {    &buttons[20].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ROUNDED_RECT,    1350,      75,    50,     25,      2, 0, "MENU",      2, 0, &greybutton,     SimPanelColor },
  { NULL,      savepicturebutton, {    &buttons[21].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ROUNDED_RECT,    1350,     125,    50,     25,      2, 0, "S PIC",     2, 0, &greybutton,     SimPanelColor },
  { NULL,         savewavebutton, {    &buttons[22].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ROUNDED_RECT,    1350,     175,    50,     25,      2, 0, "S WAV",     2, 0, &greybutton,     SimPanelColor },

  { NULL,          runstopbutton, {    &buttons[23].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ANGLES_TOP,      1455,      75,    55,     50,      2, 0, "RUN",       2, 1, &redbutton,      SimPanelColor },
  { NULL,             autobutton, {    &buttons[24].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    BUTTON_ANGLES_BOTTOM,   1455,     150,    55,     50,      2, 0, "AUTO",      2, 1, &bluebutton,     SimPanelColor },
...
void DrawOscilloscopeFrontPanel(tagXlibContext *xc)
{
  ...
  DrawFillRoundedRect(xc, 0, 0, 18, DESIGN_WIDTH, DESIGN_HEIGHT, SimPanelColor, SimBorderColor, 1);
  ...
  coloradd  = 0x020202;
  edgecolor = SimBorderColor + 0x020202;
