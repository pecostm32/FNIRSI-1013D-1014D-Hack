...

{
  ...
  FUN_8001774c(iVar1,9);                         //Set PE09 high (write)
  FUN_8001774c(iVar1,10);                        //Set PE10 high (command)

  //Write LSB of port E data register with param_1 and keep upper bytes as they where
  *(uint *)(iVar1 + 0x10) = param_1 & 0xff | *(uint *)(iVar1 + 0x10) & 0xffffff00;

  FUN_80017738(iVar1,8);                         //Set PE08 low (clock pulse)
