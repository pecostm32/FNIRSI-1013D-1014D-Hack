...

{
  ...
  do {
    ...
    do {
      if (*(char *)(DAT_8002c780 + uVar15 + 0xd) != '\0') {
        ...
        do {
          ...
          puVar18 = (ushort *)(*Global_Frame_Buffer_Pointer + ((uint)uVar3 + (uVar11 + uVar4 + uVar16) * 800 + uVar14) * 2 + iVar7);
          do {
            uVar5 = *puVar12;
            uVar17 = uVar10;
    ...
    if ((*(byte *)(DAT_8002c780 + 0xc) <= local_38) || (uVar16 = (uint)uVar2 + (uint)uVar4 + uVar16 & 0xfffcffff, DAT_8002c79c <= uVar16)) {
