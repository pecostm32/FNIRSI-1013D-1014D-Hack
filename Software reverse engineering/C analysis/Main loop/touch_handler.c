...
void touch_handler(void)
{
  ...
  if (*PTR_DAT_8001a5b4 == '\0')   //0x80192f08
  {
    ...
    *(undefined2 *)(puVar4 + 0x12) = *(undefined2 *)(iVar8 + 6);                       //0x0x80192f08 + 0x12  = short from 0x8019D5A0 + 6
    *(undefined2 *)(puVar4 + 0x14) = *(undefined2 *)(iVar8 + 0x12);                    //0x0x80192f08 + 0x14  = short from 0x8019D5A0 + 0x12
    ...
    *(undefined2 *)(puVar4 + 0x1c) = *(undefined2 *)(iVar9 + 0x9e);
    ...
    {
      *(undefined2 *)(puVar4 + 0xe) = 400;    //0x80192f08 + 0x0E
    }
  }
  else
  {
    ...
    {
      *puVar4 = 0;                     //Not so signal this some where.  0x80192f08
...
LAB_8001a410:
    if (*puVar4 == '\x01')   //Check if there was touch before. SOme state machine setup?? (0x80192f08)
    {
      ...
      {
        //When in run mode or the other variable is 11 or more
        FUN_8001ac54();
      }
...
//pa:0x8001a424
  if (*(char *)(DAT_8001a5c0 + 7) == '\0')  //0x8036137f byte pointer
  {
    cVar1 = puVar4[1];   //0x80192f09  some state byte??
    if (cVar1 == '\x04')
    {
      FUN_8001a9c0();
    }
