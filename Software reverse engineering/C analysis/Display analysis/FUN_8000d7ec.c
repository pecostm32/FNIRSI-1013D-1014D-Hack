...

{
  ...
  uVar11 = *(uint *)(PTR_DAT_8000d994 + 4);
  ...
  *(ushort *)(puVar1 + 2) =
  ...
  if (param_1 == 0) {
    ...
    set_display_color(DAT_8000d9b4);
    FUN_80018e68(DAT_8000d9b0,DAT_8000d9ac,0x316,uVar2,2);
  }
  else {
    set_display_color(*(uint *)(puVar1 + 8));
    FUN_80018ff0(DAT_8000d9b0,DAT_8000d9ac,0x316,uVar2,2);
    uVar14 = 0;
    do {
      iVar15 = 0x3c;
  ...
  uVar11 = DAT_8000d9b8;
  uVar14 = DAT_8000d9b8 - 0x37;
  iVar8 = DAT_8000d9b8 + 0x101;
  iVar9 = DAT_8000d9b8 - iVar8;
  if (DAT_8000d9b8 <= uVar14) {
    return;
  }
  do {
