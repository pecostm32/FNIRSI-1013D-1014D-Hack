...

{
  ...
  uVar11 = *(uint *)(PTR_DAT_8000c828 + 4);
  ...
  *(ushort *)(puVar1 + 2) =
  ...
  if (param_1 == 0) {
    ...
    set_display_color(DAT_8000c848);
    FUN_80018e68(DAT_8000c844,DAT_8000c840,0x316,uVar2,2);
  }
  else {
    set_display_color(*(uint *)(puVar1 + 8));
    FUN_80018ff0(DAT_8000c844,DAT_8000c840,0x316,uVar2,2);
    uVar14 = 0;
    do {
      iVar15 = 0x3c;
  ...
  uVar11 = DAT_8000c84c;
  uVar14 = DAT_8000c84c - 0x37;
  iVar8 = DAT_8000c84c + 0x13d;
  iVar9 = DAT_8000c84c - iVar8;
  if (DAT_8000c84c <= uVar14) {
    return;
  }
  do {
    iVar10 = iVar8 + uVar14 * 800;
    copy_short((void *)(iVar15 + iVar10 * 2),(void *)(iVar5 + iVar10 * 2),iVar9 + 0x17d);
    uVar14 = uVar14 + 1;
  } while (uVar14 < uVar11);
  return;
}
