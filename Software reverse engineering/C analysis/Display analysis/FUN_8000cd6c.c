...

{
  ...
  uVar11 = *(uint *)(PTR_DAT_8000cf04 + 4);
  ...
  *(ushort *)(puVar1 + 2) =
  ...
  if (param_1 == 0) {
    ...
    set_display_color(DAT_8000cf24);
    FUN_80018e68(DAT_8000cf20,DAT_8000cf1c,0x316,uVar2,2);
  }
  else {
    set_display_color(*(uint *)(puVar1 + 8));
    FUN_80018ff0(DAT_8000cf20,DAT_8000cf1c,0x316,uVar2,2);
    uVar14 = 0;
    do {
      iVar15 = 0x3c;
  ...
  uVar11 = DAT_8000cf28;
  uVar14 = DAT_8000cf28 - 0x37;
  iVar8 = DAT_8000cf28 + 0x101;
  iVar9 = DAT_8000cf28 - iVar8;
  if (DAT_8000cf28 <= uVar14) {
    return;
  }
  do {
