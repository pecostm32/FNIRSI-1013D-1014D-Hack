...

{
  ...
  uVar11 = *(uint *)(PTR_DAT_8000d450 + 4);
  ...
  *(ushort *)(puVar1 + 2) =
  ...
  if (param_1 == 0) {
    ...
    do {
      ...
      puVar13 = (ushort *)(puVar3 + uVar14 * 0xf0);
      do {
        uVar6 = *puVar13;
        if (uVar6 == uVar11) {
          uVar6 = *(ushort *)puVar1;
    ...
    set_display_color(DAT_8000d470);
    FUN_80018e68(DAT_8000d46c,DAT_8000d468,0x316,uVar2,2);
  }
  else {
    set_display_color(*(uint *)(puVar1 + 8));
    FUN_80018ff0(DAT_8000d46c,DAT_8000d468,0x316,uVar2,2);
    uVar14 = 0;
    do {
      iVar15 = 0x3c;
      puVar12 = (undefined2 *)(*piVar4 + uVar14 * 0x640 + iVar5);
      puVar7 = (ushort *)(puVar3 + uVar14 * 0xf0);
      do {
        if (*puVar7 == uVar11) {
  ...
  uVar11 = DAT_8000d474;
  uVar14 = DAT_8000d474 - 0x37;
  iVar8 = DAT_8000d474 + 0x101;
  iVar9 = DAT_8000d474 - iVar8;
  if (DAT_8000d474 <= uVar14) {
    return;
  }
  do {
