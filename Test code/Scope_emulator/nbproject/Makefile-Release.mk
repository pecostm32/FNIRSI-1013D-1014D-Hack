...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/scope_emulator: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/scope_emulator ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/ScopeEmulator.o: ScopeEmulator.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ScopeEmulator.o ScopeEmulator.c

${OBJECTDIR}/armthread.o: armthread.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/armthread.o armthread.c
...
${OBJECTDIR}/f1c100s_uart.o: f1c100s_uart.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/f1c100s_uart.o f1c100s_uart.c

${OBJECTDIR}/lcdisplay.o: lcdisplay.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lcdisplay.o lcdisplay.c
