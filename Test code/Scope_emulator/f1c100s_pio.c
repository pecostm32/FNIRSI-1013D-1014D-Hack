...
//                pd->read_ptr = scope_ch1_data;
              ...
              case 0x20:  //Channel 1
//                registers->data.m_8bit[0] = 0x80;
                pd->read_count = 1500;
                pd->read_ptr = scope_ch1_data;
                break;
                
              case 0x21:  //Channel 2
                registers->data.m_8bit[0] = 0x50;
//                pd->read_count = 1500;
...
//              case 0x20:
//                if((pd->read_count > 1125) || ((pd->read_count > 375) && (pd->read_count < 750)))
//                  registers->data.m_8bit[0] = 0xB0;
//                else
//                  registers->data.m_8bit[0] = 0x90;
                
//                pd->read_count--;
//                break;
                
//              case 0x21:
//                if(pd->read_count > 1125)
//                  registers->data.m_8bit[0] = 0x10;
//                else
//                  registers->data.m_8bit[0] = 0x20;
