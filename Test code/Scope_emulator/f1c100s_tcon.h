...
#define TCON_CTRL_IO_MAP_SEL_TCON0           0xFFFFFFFE         //And with to use the TCON0 registers instead of the TCON1 registers
#define TCON_CTRL_IO_MAP_SEL_TCON1           0x00000001         //Or with to use the TCON1 registers instead of the TCON0 registers
