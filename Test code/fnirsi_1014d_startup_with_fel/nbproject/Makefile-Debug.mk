...
OBJECTFILES= \
	...
	${OBJECTDIR}/fnirsi_1014d_startup_with_fel.o \
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fnirsi_1014d_startup_with_fel.elf

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fnirsi_1014d_startup_with_fel.elf: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	arm-none-eabi-gcc -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fnirsi_1014d_startup_with_fel.elf ${OBJECTFILES} ${LDLIBSOPTIONS} -T./fnirsi_1014d.ld -nostdlib
...
${OBJECTDIR}/fnirsi_1014d_startup_with_fel.o: fnirsi_1014d_startup_with_fel.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fnirsi_1014d_startup_with_fel.o fnirsi_1014d_startup_with_fel.c
