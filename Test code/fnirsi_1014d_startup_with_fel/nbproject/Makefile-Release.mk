...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fnirsi_1014d_startup_with_fel

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fnirsi_1014d_startup_with_fel: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	arm-none-eabi-gcc -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fnirsi_1014d_startup_with_fel ${OBJECTFILES} ${LDLIBSOPTIONS} -T./stm32f103-64k.ld -nostdlib
...
${OBJECTDIR}/fnirsi_1014d_startup_with_fel.o: fnirsi_1014d_startup_with_fel.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fnirsi_1014d_startup_with_fel.o fnirsi_1014d_startup_with_fel.c
