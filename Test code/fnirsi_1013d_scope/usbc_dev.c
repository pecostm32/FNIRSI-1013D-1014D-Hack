...
void USBC_Clear_Feature_HALT(uint32 ep_type)
{
  ...
  {
    case USBC_EP_TYPE_TX:
      USBC_Writew((1 << USBC_BP_TXCSR_D_MODE) | (1 << USBC_BP_TXCSR_D_CLEAR_DATA_TOGGLE) | (1 << USBC_BP_TXCSR_D_FLUSH_FIFO), USBC_REG_TXCSR(USBC0_BASE));
      break;

    case USBC_EP_TYPE_RX:
      USBC_Writew((1 << USBC_BP_RXCSR_D_CLEAR_DATA_TOGGLE) | (1 << USBC_BP_RXCSR_D_FLUSH_FIFO), USBC_REG_RXCSR(USBC0_BASE));
      break;
  }
}
