...
OBJECTFILES= \
	...
	${OBJECTDIR}/fnirsi_sd_card_bootloader.o \
	${OBJECTDIR}/memcmp.o \
	${OBJECTDIR}/memcpy.o \
	${OBJECTDIR}/memset.o \
	${OBJECTDIR}/start.o
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fnirsi_sd_card_bootloader

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fnirsi_sd_card_bootloader: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	arm-none-eabi-gcc -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fnirsi_sd_card_bootloader ${OBJECTFILES} ${LDLIBSOPTIONS} -T./fnirsi_sd_card_bootloader.ld -nostdlib -lgcc
...
${OBJECTDIR}/fnirsi_sd_card_bootloader.o: fnirsi_sd_card_bootloader.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fnirsi_sd_card_bootloader.o fnirsi_sd_card_bootloader.c
