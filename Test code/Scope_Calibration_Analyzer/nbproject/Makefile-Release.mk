...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/scope_calibration_analyzer: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/scope_calibration_analyzer ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/Scope_Calibration_Analyzer.o: Scope_Calibration_Analyzer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Scope_Calibration_Analyzer.o Scope_Calibration_Analyzer.c
