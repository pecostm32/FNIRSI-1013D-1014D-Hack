...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/oscilloscope_emulator: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/oscilloscope_emulator ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/oscilloscope_emulator.o: oscilloscope_emulator.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/oscilloscope_emulator.o oscilloscope_emulator.c
