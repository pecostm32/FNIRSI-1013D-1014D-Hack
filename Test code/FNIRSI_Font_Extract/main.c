...
//Need a function to get font information from the buffer and return the next_info value so looping can be done
//This function needs to get the character data and write it to a header file.

//Create a header file with font structure information in it and include that in the font files

//unsigned char char_0x20_data[] = { 0x00, 0x01, 0x02, 0x03 };
//unsigned char char_0x21_data[] = { 0x00, 0x01, 0x02, 0x03 };

//FONTMETRICS font_0[] =
//{
//  { 0x07, 0x07, 0x01, 0x00, char_0x20_data },
//  { 0x07, 0x07, 0x01, 0x00, char_0x21_data },
//};

//FONTINFORMATION font_0_information_0 = {    };