...
OBJECTFILES= \
	...
	${OBJECTDIR}/Scope_Signal_Analyzer.o \
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/scope_signal_analyzer

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/scope_signal_analyzer: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/scope_signal_analyzer ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/_ext/4a4fb115/font_7.o: ../../F1C100s/fnirsi_1013d_scope/font_7.c
	${MKDIR} -p ${OBJECTDIR}/_ext/4a4fb115
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4a4fb115/font_7.o ../../F1C100s/fnirsi_1013d_scope/font_7.c
...
${OBJECTDIR}/Scope_Signal_Analyzer.o: Scope_Signal_Analyzer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Scope_Signal_Analyzer.o Scope_Signal_Analyzer.c
