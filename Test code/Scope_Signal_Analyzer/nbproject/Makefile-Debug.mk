...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/scope_signal_analyzer: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/scope_signal_analyzer ${OBJECTFILES} ${LDLIBSOPTIONS} -lX11 -lXft -lXrandr -lpthread
...
${OBJECTDIR}/Scope_Signal_Analyzer.o: Scope_Signal_Analyzer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I/usr/include/freetype2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Scope_Signal_Analyzer.o Scope_Signal_Analyzer.c
