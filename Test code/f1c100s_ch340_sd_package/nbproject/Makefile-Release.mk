...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/f1c100s_ch340_sd_package

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/f1c100s_ch340_sd_package: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	arm-none-eabi-gcc -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/f1c100s_ch340_sd_package ${OBJECTFILES} ${LDLIBSOPTIONS} -T./stm32f103-64k.ld -nostdlib
...
${OBJECTDIR}/f1c100s_ch340_sd_package.o: f1c100s_ch340_sd_package.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/f1c100s_ch340_sd_package.o f1c100s_ch340_sd_package.c
