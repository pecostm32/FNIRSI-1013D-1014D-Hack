...
OBJECTFILES= \
	...
	${OBJECTDIR}/f1c100s_ch340_sd_package.o \
	${OBJECTDIR}/memcmp.o \
	${OBJECTDIR}/memcpy.o \
	${OBJECTDIR}/memset.o \
	${OBJECTDIR}/start.o
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/f1c100s_ch340_sd_package.elf

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/f1c100s_ch340_sd_package.elf: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	arm-none-eabi-gcc -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/f1c100s_ch340_sd_package.elf ${OBJECTFILES} ${LDLIBSOPTIONS} -T./fnirsi_1013d.ld -nostdlib -lgcc
...
${OBJECTDIR}/f1c100s_ch340_sd_package.o: f1c100s_ch340_sd_package.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/f1c100s_ch340_sd_package.o f1c100s_ch340_sd_package.c
