...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/display_lib_test: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/display_lib_test ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/display_lib_test.o: display_lib_test.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/display_lib_test.o display_lib_test.c
