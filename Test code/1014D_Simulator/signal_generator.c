...
tagSG_RotaryDial sgrotarydials[] =
{
...
tagSG_Button sgbuttons[] = 
{
  //        Mouserange set here to make a linked list. Search for object under mouse pointer needs to be done from last to first based on previous pointer
  //  xc,                 action,                previous, left, right, top, bottom, move, down,   up,  out,                     type,    xpos,    ypos, 
  { NULL,         initializewaveformedit, { &sgrotarydials[0].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, MODE_X1, MODE_Y1, 120, 40, 0, "WAVEFORM",   2, ButtonTextColorId },
  { NULL,        initializefrequencyedit, {     &sgbuttons[0].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, MODE_X1, MODE_Y2, 120, 40, 0, "FREQUENCY",  2, ButtonTextColorId },
  { NULL,            initializephaseedit, {     &sgbuttons[1].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, MODE_X1, MODE_Y3, 120, 40, 0, "PHASE",      2, ButtonTextColorId },
  { NULL,                           NULL, {     &sgbuttons[2].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, MODE_X1, MODE_Y4, 120, 40, 0, "LOAD",       2, ButtonTextColorId },
  
  { NULL,        initializeamplitudeedit, {     &sgbuttons[3].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, MODE_X2, MODE_Y1, 120, 40, 0, "AMPLITUDE",   2, ButtonTextColorId },
  { NULL,         initializedcoffsetedit, {     &sgbuttons[4].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, MODE_X2, MODE_Y2, 120, 40, 0, "DC OFFSET",   2, ButtonTextColorId },
  { NULL,       initializepulsewidthedit, {     &sgbuttons[5].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, MODE_X2, MODE_Y3, 120, 40, 0, "PULSE WIDTH", 2, ButtonTextColorId },
  { NULL,                           NULL, {     &sgbuttons[6].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, MODE_X2, MODE_Y4, 120, 40, 0, "SAVE",        2, ButtonTextColorId },
  
  { NULL,              selectfrequencyhz, {  &sgbuttons[7].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, MAGNITUDE_X1,  MAGNITUDE_Y1, 100, 35, 0, "HZ",        2, ButtonTextColorId },
  { NULL,             selectfrequencykhz, {  &sgbuttons[8].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, MAGNITUDE_X1,  MAGNITUDE_Y2, 100, 35, 0, "KHz",       2, ButtonTextColorId },
  { NULL,             selectfrequencymhz, {  &sgbuttons[9].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, MAGNITUDE_X1,  MAGNITUDE_Y3, 100, 35, 0, "MHz",       2, ButtonTextColorId },

  { NULL,            togglechannelselect, { &sgbuttons[10].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, SELECT_X2, SELECT_Y1, 100, 35, 0, "CH1 / CH2",  2, ButtonTextColorId },
  
  { NULL,             handleleftarrowkey, { &sgbuttons[11].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ARROW_LEFT, SELECT_X4, SELECT_Y1, 35, 35, 0, NULL,        0, 0 },
  { NULL,            handlerightarrowkey, { &sgbuttons[12].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ARROW_RIGHT, SELECT_X5, SELECT_Y1, 35, 35, 0, NULL,        0, 0 },

  { NULL,               handlenumber7key, { &sgbuttons[13].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, KEYPAD_X1,  KEYPAD_Y1, 35, 35, 0, "7",        2, ButtonTextColorId },
  { NULL,               handlenumber8key, { &sgbuttons[14].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, KEYPAD_X2,  KEYPAD_Y1, 35, 35, 0, "8",        2, ButtonTextColorId },
  { NULL,               handlenumber9key, { &sgbuttons[15].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, KEYPAD_X3,  KEYPAD_Y1, 35, 35, 0, "9",        2, ButtonTextColorId },

  { NULL,               handlenumber4key, { &sgbuttons[16].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, KEYPAD_X1,  KEYPAD_Y2, 35, 35, 0, "4",        2, ButtonTextColorId },
  { NULL,               handlenumber5key, { &sgbuttons[17].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, KEYPAD_X2,  KEYPAD_Y2, 35, 35, 0, "5",        2, ButtonTextColorId },
  { NULL,               handlenumber6key, { &sgbuttons[18].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, KEYPAD_X3,  KEYPAD_Y2, 35, 35, 0, "6",        2, ButtonTextColorId },

  { NULL,               handlenumber1key, { &sgbuttons[19].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, KEYPAD_X1,  KEYPAD_Y3, 35, 35, 0, "1",        2, ButtonTextColorId },
  { NULL,               handlenumber2key, { &sgbuttons[20].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, KEYPAD_X2,  KEYPAD_Y3, 35, 35, 0, "2",        2, ButtonTextColorId },
  { NULL,               handlenumber3key, { &sgbuttons[21].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, KEYPAD_X3,  KEYPAD_Y3, 35, 35, 0, "3",        2, ButtonTextColorId },

  { NULL,               handlenumber0key, { &sgbuttons[22].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, KEYPAD_X1,  KEYPAD_Y4, 80, 35, 0, "0",        2, ButtonTextColorId },
  { NULL,             handlenumberdotkey, { &sgbuttons[23].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, KEYPAD_X3,  KEYPAD_Y4, 35, 35, 0, ".",        2, ButtonTextColorId },

  { NULL,           handlenumberminuskey, { &sgbuttons[24].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, KEYPAD_X4,  KEYPAD_Y1, 80, 35, 0, "-",        2, ButtonTextColorId },
  { NULL,            handlenumberpluskey, { &sgbuttons[25].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, KEYPAD_X4,  KEYPAD_Y2, 80, 35, 0, "+",        2, ButtonTextColorId },

  { NULL,          handlenumbercancelkey, { &sgbuttons[26].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, KEYPAD_X4,  KEYPAD_Y3, 80, 35, 0, "CANCEL",   2, ButtonTextColorId },
  { NULL,           handlenumberenterkey, { &sgbuttons[27].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, KEYPAD_X4,  KEYPAD_Y4, 80, 35, 0, "ENTER",    2, ButtonTextColorId },

  { NULL,           togglechannel1enable, { &sgbuttons[28].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, CHANNEL1_X1, CHANNEL_Y2, 100, 35, 0, "ON / OFF",    2, ButtonTextColorId },
  { NULL, togglechannel1pulsewidthenable, { &sgbuttons[29].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, CHANNEL1_X4, CHANNEL_Y2, 100, 35, 0, "ON / OFF",    2, ButtonTextColorId },

  { NULL,           togglechannel2enable, { &sgbuttons[30].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, CHANNEL2_X1, CHANNEL_Y2, 100, 35, 0, "ON / OFF",    2, ButtonTextColorId },
  { NULL, togglechannel2pulsewidthenable, { &sgbuttons[31].mouse,    0,     0,   0,      0, NULL, NULL, NULL, NULL },    SG_BUTTON_ROUNDED_RECT, CHANNEL2_X4, CHANNEL_Y2, 100, 35, 0, "ON / OFF",    2, ButtonTextColorId },
};

//Set pointer to last mouse range for scanning
MouseRange *mouseranges = &sgbuttons[32].mouse;
...
void DrawSignalGeneratorFrontPanel(tagXlibContext *xc)
{
  ...
  n = sizeof(sgrotarydials) / sizeof(tagSG_RotaryDial);
  for(i=0;i<n;i++)
    SG_RotaryDialSetup(xc, &sgrotarydials[i]);
   
  //Setup all the buttons
  n = sizeof(sgbuttons) / sizeof(tagSG_Button);
  for(i=0;i<n;i++)
    SG_ButtonSetup(xc, &sgbuttons[i]);
